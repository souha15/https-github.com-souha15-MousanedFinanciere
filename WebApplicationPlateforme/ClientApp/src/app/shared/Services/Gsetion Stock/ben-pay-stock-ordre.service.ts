...
export class BenPayStockOrdreService {
  ...
  CreateBenPayStockOrdre(tache: BenPayStockOrdre) {
    return this.http.post<BenPayStockOrdre>(this.rootURL + '/BenPayStockOrdres', tache, this.headers);
  }

  //Edit BenPayStockOrdre
  EditBenPayStockOrdre() {
    return this.http.put(this.rootURL + '/BenPayStockOrdres/' + this.formData.id, this.formData, this.headers);
  }

  // List BenPayStockOrdre

  ListBenPayStockOrdre(): Observable<BenPayStockOrdre[]> {
    return this.http.get<BenPayStockOrdre[]>(this.rootURL + '/BenPayStockOrdres');
  }

  //Delete BenPayStockOrdre

  DeleteBenPayStockOrdre(id) {
    return this.http.delete(this.rootURL + '/BenPayStockOrdres/' + id);
  }

  //Put BenPayStockOrdre

  PutBenPayStockOrdreObservable(tache: BenPayStockOrdre, Id: number) {
    return this.http.put<BenPayStockOrdre>(this.rootURL + '/BenPayStockOrdres/' + Id, tache, this.headers);
  }
  ...
  GetById(Id) {
    return this.http.get<BenPayStockOrdre>(this.rootURL + '/BenPayStockOrdres/' + Id);
  }
}
