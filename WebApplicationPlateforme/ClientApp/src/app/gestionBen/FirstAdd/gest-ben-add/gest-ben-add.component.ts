...
@Component({
  selector: 'app-gest-ben-add',
  templateUrl: './gest-ben-add.component.html',
  styleUrls: ['./gest-ben-add.component.css']
})
export class GestBenAddComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    if (form.invalid) {
      ...
      this.gest.etat = "غير نشط";
      this.benService.CreateGestBen(this.gest).subscribe(res => {
        this.Id = res.id
        //Famille Add
        if (this.fmtest) {
