...
@Component({
  selector: 'app-gest-ben-list-chercheur',
  templateUrl: './gest-ben-list-chercheur.component.html',
  styleUrls: ['./gest-ben-list-chercheur.component.css']
})
export class GestBenListChercheurComponent implements OnInit {
